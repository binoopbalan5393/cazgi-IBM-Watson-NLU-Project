...
function getNLUInstance() {
    ...
    const naturalLanguageUnderstanding = new NaturalLanguageUnderstandingV1({
        ...
        authenticator: new IamAuthenticator ({
            apikey: 'X74e3sgR5GO7gp5YyUXOfGN6DwqYNE2LMSxQpg6IcXKJ'
        }),
        serviceUrl: 'https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/9739da97-a8d0-4a08-8c5b-4d56d31d8d97'
    });
